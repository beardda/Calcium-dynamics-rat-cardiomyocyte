function [scvrmse,AIC,output] = CalciumModel_withBARLCCPLB_withoutCaMK()

par = [];
load parset_withBARLCCPLB_withoutCaMK
...
AIC = 2*30 + chisquare1 + chisquare2 + chisquare3 + chisquare4 + chisquare5 + chisquare6
