function [scvrmse,AIC,output] = CalciumModel_withBARLCCPLB_withCaMKLCCPLB()

par = [];
load parset_withBARLCCPLB_withCaMKLCCPLB
...
% CaMK
phi_plb_4Hz_CaMK_con = par(31);
phi_plb_6Hz_CaMK_con = par(32);
phi_plb_8Hz_CaMK_con = par(33);

phi_plb_4Hz_CaMK_iso = par(34);
phi_plb_6Hz_CaMK_iso = par(35);
phi_plb_8Hz_CaMK_iso = par(36);

phi_lcc_4Hz_CaMK_con = par(37);
phi_lcc_6Hz_CaMK_con = par(38);
phi_lcc_8Hz_CaMK_con = par(39);

phi_lcc_4Hz_CaMK_iso = par(40);
phi_lcc_6Hz_CaMK_iso = par(41);
phi_lcc_8Hz_CaMK_iso = par(42);
...
AIC = 2*42 + chisquare1 + chisquare2 + chisquare3 + chisquare4 + chisquare5 + chisquare6
